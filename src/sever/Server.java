...
import photosynthesis_solution.photosynthesis_solution;
...
public class Server {  
    ...
    public static void main(String[] args) throws Throwable {  
       //  为了简单起见，所有的异常信息都往外抛  
        ...
        // server.close(); 
//        String result;
//    	 result = judgmentP("auto_io1_006","O2 H");
    }  
    ...
    static class Task implements Runnable {  
         ...
         * @throws IOException 
         */  
        private void handlerSocket() throws Throwable {  
            ...
            String result;
            String []data_spilt = sb.toString().split("&");//把发过来的字符串分开
            ...
            writer.write(String.format(result, socket.getPort()));  
            writer.flush();  
            writer.close();  
            System.out.println(  
	...
	{//我要在这里读一下题目数据。联系起来然后反馈产生的结果
		...
		for(String s :love_question){
			...
			if(split[0].contains(q_id)){
				q_content = q_content.replace(" ", ",");//O2 H防止里面出现空格影响下一步分割
				request = s +" "+q_content;

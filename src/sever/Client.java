...
public class Client {  
            ...
            new Thread(new Runnable() {  
                ...
                public void run() {  
                    try {  
                        ...
                        //auto_io1_006 output 光合作用中水的光解会生成哪些产物？
                        client.send(String.format("auto_loc_007"+"&"+"叶绿体", client.client.getLocalPort()));  
                        client.receive();  
                    } catch (Exception e) {  
                        e.printStackTrace();  
                    }  
    ...
    static class TestClientFactory {  
        ...
        public static TestClient createClient() throws Exception {  
            //return new TestClient("localhost", 8989);  
            return new TestClient("localhost", 8989);  
        }  
    ...
    static class TestClient {  
        ...
        public void send(String msg) throws Exception {  
            ...
            System.out.println("Cliect[port:" + client.getLocalPort() + msg+"] 消息发送成功");  
        }  
